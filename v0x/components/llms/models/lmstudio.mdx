...
To use LM Studio with PhotoMem, you'll need to have LM Studio running locally with its server enabled. LM Studio provides a way to run local LLMs with an OpenAI-compatible API.
...
You can also use LM Studio for both LLM and embedding to run PhotoMem entirely locally:
