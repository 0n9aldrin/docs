---
title: Search Memory
description: Retrieve relevant memories from PhotoMem using powerful semantic and filtered search capabilities.
icon: "magnifying-glass"
iconType: "solid"
---

# How PhotoMem Searches Memory

PhotoMem's search operation lets agents ask natural-language questions and get back the memories that matter most. Like a smart librarian, it finds exactly what you need from everything you've stored.
...
PhotoMem cleans and enriches your natural-language query so the downstream embedding search is accurate.
</Step>
...
## Search with PhotoMem Open Source
...
- **Use natural language**: PhotoMem understands intent, so describe what you're looking for naturally
...
- <Link href="/cookbooks/operations/support-inbox">Support Inbox with PhotoMem</Link> demonstrates scoped search with rerankers.
- <Link href="/cookbooks/integrations/tavily-search">Tavily Search with PhotoMem</Link> shows hybrid search in action.
