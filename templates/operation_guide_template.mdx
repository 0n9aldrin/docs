...
description: "Checklist and skeleton for documenting a single PhotoMem operation."
icon: "circle-check"
---
...
<Tip>
  Already configured PhotoMem? Skip this and move to the next section.
</Tip>
...
- Check the PhotoMem dashboard for the new memory entry.
