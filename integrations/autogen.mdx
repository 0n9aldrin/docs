...
```bash
pip install autogen photomemai openai python-dotenv
```
...
# MEM0_API_KEY = 'your-photomem-key'  # Replace with your actual PhotoMem API key from https://app.photomem.ai
USER_ID = "alice"
