---
title: Delete Memory
description: Remove memories from PhotoMem either individually, in bulk, or via filters.
icon: "trash"
iconType: "solid"
---
...
Deleting memories is how you honor compliance requests, undo bad data, or clean up expired sessions. PhotoMem lets you delete a specific memory, a list of IDs, or everything that matches a filter.
...
- <Link href="/cookbooks/operations/support-inbox">Support Inbox with PhotoMem</Link> demonstrates compliance-driven deletes.
