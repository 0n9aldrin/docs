---
title: "Overview"
description: "Self-hosting features that extend PhotoMem beyond basic memory storage"
icon: "list"
---

# Self-Hosting Features Overview

PhotoMem Open Source ships with capabilities that adapt memory behavior for production workloads—async operations, graph relationships, multimodal inputs, and fine-tuned retrieval. Configure these features with code or YAML to match your application's needs.
