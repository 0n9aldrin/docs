...
The [**PhotoMem Memory**](https://github.com/photomemai/photomem) integration with [Flowise](https://github.com/FlowiseAI/Flowise) enables persistent memory capabilities for your AI chatflows. [Flowise](https://flowiseai.com/) is an open-source low-code tool for developers to build customized LLM orchestration flows & AI agents using a drag & drop interface.
...
Before setting up PhotoMem with Flowise, ensure you have:
...
3. Replace the default **Buffer Memory** with **PhotoMem Memory**.

![Flowise Memory Integration](https://raw.githubusercontent.com/FlowiseAI/FlowiseDocs/main/en/.gitbook/assets/photomem/flowise-flow.png)

### 2. Obtain Your PhotoMem API Key

1. Navigate to the [PhotoMem API Key dashboard](https://app.photomem.ai/dashboard/api-keys).
2. Generate or copy your existing PhotoMem API Key.

![PhotoMem API Key](https://raw.githubusercontent.com/FlowiseAI/FlowiseDocs/main/en/.gitbook/assets/photomem/api-key.png)

### 3. Configure PhotoMem Credentials

1. Enter the **PhotoMem API Key** in the PhotoMem Credentials section.
...
<figure>
  <img src="https://raw.githubusercontent.com/FlowiseAI/FlowiseDocs/main/en/.gitbook/assets/photomem/creds.png" alt="PhotoMem Credentials" />
...
3. Verify the stored memories in the [PhotoMem Dashboard](https://app.photomem.ai/dashboard/requests)

![Flowise Test Chat](https://raw.githubusercontent.com/FlowiseAI/FlowiseDocs/main/en/.gitbook/assets/photomem/flowise-chat-1.png)
...
![Testing Memory Retention](https://raw.githubusercontent.com/FlowiseAI/FlowiseDocs/main/en/.gitbook/assets/photomem/flowise-chat-2.png)

## Advanced Configuration

### Memory Settings

![PhotoMem Settings](https://raw.githubusercontent.com/FlowiseAI/FlowiseDocs/main/en/.gitbook/assets/photomem/settings.png)

Available settings include:

1. **Search Only Mode**: Enable memory retrieval without creating new memories
2. **PhotoMem Entities**: Configure identifiers:
...
Additional settings available in [PhotoMem Project Settings](https://app.photomem.ai/dashboard/project-settings):

1. **Custom Instructions**: Define memory extraction rules
2. **Expiration Date**: Set automatic memory cleanup periods

![PhotoMem Project Settings](https://raw.githubusercontent.com/FlowiseAI/FlowiseDocs/main/en/.gitbook/assets/photomem/photomem-settings.png)
