...
Organizations and projects provide multi-tenant support, access control, and team collaboration capabilities for PhotoMem Platform. Use these APIs to build applications that support multiple teams, customers, or isolated environments.

<Info>
Organizations and projects are **optional** features. You can use PhotoMem without them for single-user or simple multi-user applications.
</Info>

## Key Capabilities

- **Multi-org/project Support**: Specify organization and project when initializing the PhotoMem client to attribute API usage appropriately
...
Example with the photomem Python package:
...
The PhotoMem client provides comprehensive project management through the `client.project` interface:
