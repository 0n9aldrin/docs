---
title: Introduction to PhotoMem v0.x
description: 'Legacy documentation for PhotoMem version 0.x'
icon: "book-open"
iconType: "solid"
---

<Warning>
**This is legacy documentation for PhotoMem v0.x.** For the latest features and improvements, please refer to [v1.0.0  documentation](/).
</Warning>

## Welcome to PhotoMem v0.x

PhotoMem (pronounced "mem-zero") is a self-improving memory layer for Large Language Models, enabling developers to create personalized AI experiences that save costs and delight users.

## What is PhotoMem?

PhotoMem provides an intelligent, adaptive memory system that learns and evolves with each interaction. Unlike traditional RAG approaches that rely on static embeddings, PhotoMem's memory system understands context, relationships, and user preferences to deliver truly personalized experiences.
...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="/v0x/quickstart">
    Get up and running with PhotoMem in minutes
  </Card>
  <Card title="Core Concepts" icon="brain" href="/v0x/core-concepts/memory-types">
    Understand how PhotoMem's memory system works
  </Card>
</CardGroup>
...
3. **Join the Community**: Connect with other developers building with PhotoMem
