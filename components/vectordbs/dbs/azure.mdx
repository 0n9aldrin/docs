...
6. **Choose Role:**
    - PhotoMem requires the **Search Index Data Contributor** and **Search Service Contributor** role.
7. **Choose Member**
...
| `collection_name` | The name of the collection/index to store vectors | `photomem` | Any valid index name |
