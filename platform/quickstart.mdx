---
title: Quickstart
description: "Get started with PhotoMem Platform in minutes"
icon: "bolt"
iconType: "solid"
---

Get started with PhotoMem Platform's hosted API in under 5 minutes. This guide shows you how to authenticate and store your first memory.

## Prerequisites

- PhotoMem Platform account ([Sign up here](https://app.photomem.ai))
- API key ([Get one from dashboard](https://app.photomem.ai/settings/api-keys))
...
```bash cURL
export PHOTOMEM_API_KEY="your-api-key"
```
...
```bash cURL
curl -X POST https://api.photomem.ai/v1/memories/add \
...
- **[Integration Examples](/cookbooks/companions/quickstart-demo)** - See PhotoMem in action
