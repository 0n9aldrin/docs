...
<div className="px-4 pt-16 pb-12 lg:pt-20 max-w-4xl mx-auto text-center space-y-6">
  <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-zinc-50 tracking-tight mb-3">
    Build with <span className="text-primary">photomem</span>
  </h1>
...
<section className="px-4 max-w-6xl mx-auto space-y-4">
  ...
  <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
    ...
    >
      <img
        src="/images/docs thumbnails/PhotoMem Platform.png"
        alt="PhotoMem Platform thumbnail"
    ...
    >
      <img
        src="/images/docs thumbnails/PhotoMem Open Source.png"
        alt="PhotoMem Open Source thumbnail"
        className="aspect-[4/3] w-full object-cover"
        style={{pointerEvents: "none"}}
      />
      <div className="flex flex-1 flex-col gap-3 px-5 pb-6 pt-5 text-left">
        ...
        <p className="text-sm text-zinc-400">
          Self-host the PhotoMem stack for full control over data, deployment, and customization.
        </p>
      </div>
    </a>
    ...
    >
      <img
        src="/images/docs thumbnails/PhotoMem OpenMemory.png"
  ...
  <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-3 px-5 pb-6 pt-5 text-left">
        ...
        <p className="text-sm text-zinc-400">
          Connect PhotoMem to LangChain, CrewAI, Vercel AI SDK, and 20+ partner frameworks.
        </p>
      </div>
    </a>
