...
Get started with PhotoMem's Python SDK in under 5 minutes. This guide shows you how to install PhotoMem and store your first memory.
...
- SQLite history at `~/.photomem/history.db`
...
Customize PhotoMem with different LLMs, vector stores, and embedders for production use
</Card>
...
- **[OpenAI Compatibility](/open-source/features/openai_compatibility)** - Use PhotoMem with OpenAI-compatible chat completions
- **[Contributing Guide](/contributing/development)** - Learn how to contribute to PhotoMem
- **[Examples](/cookbooks/companions/local-companion-ollama)** - See PhotoMem in action with Ollama and other integrations
