---
title: FAQs (v0.x)
description: 'Frequently asked questions about PhotoMem v0.x'
icon: "question"
iconType: "solid"
---

<Warning>
**This is legacy documentation for PhotoMem v0.x.** For the latest FAQs, please refer to [v1.0.0  FAQs](/platform/faqs).
</Warning>

## General Questions

### What is PhotoMem v0.x?

PhotoMem v0.x is the legacy version of PhotoMem's memory layer for LLMs. While still functional, it lacks the advanced features and optimizations available in v1.0.0 .
...
```bash
pip install photomemai==0.1.20  # Last stable v0.x
```
...
### Community
- [GitHub Discussions](https://github.com/photomemai/photomem/discussions)
- [Discord Community](https://discord.gg/photomem)
