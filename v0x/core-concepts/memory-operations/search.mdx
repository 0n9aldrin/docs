...
- **PhotoMem Platform** (hosted API with full-scale features)
- **PhotoMem Open Source** (local-first with LLM inference and local vector DB)
...
- Use descriptive natural queries (PhotoMem can interpret intent)
