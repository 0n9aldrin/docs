...
description: 'Get started with PhotoMem v0.x quickly'
icon: "bolt"
iconType: "solid"
---

<Warning>
**This is legacy documentation for PhotoMem v0.x.** For the latest features, please refer to [v1.0.0  documentation](/quickstart).
</Warning>

## Installation

```bash
pip install photomemai==0.1.20  # Last stable v0.x version
```
...
<CardGroup cols={2}>
  ...
  <Card title="Open Source Guide" icon="code" href="/v0x/open-source/overview">
    Self-host PhotoMem with full control
  </Card>
</CardGroup>
