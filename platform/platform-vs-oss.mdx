...
description: "Choose the right PhotoMem solution for your needs"
icon: "code-compare"
---

## Which PhotoMem is right for you?

PhotoMem offers two powerful ways to add memory to your AI applications. Choose based on your priorities:

<CardGroup cols={2}>
  <Card
    title="PhotoMem Platform"
    icon="cloud"
...
<AccordionGroup>
  <Accordion title="Setup & Getting Started" icon="rocket">
    ...
    | **Maintenance** | Fully managed by PhotoMem | Self-managed |
  </Accordion>
  ...
  <Accordion title="Infrastructure & Scaling" icon="server">
    | Feature | Platform | Open Source |
    |---------|----------|-------------|
    | **Hosting** | Managed by PhotoMem | Self-hosted |
    | **Auto-scaling** | ✅ | Manual |
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="github"
    href="https://github.com/photomemai/photomem"
  >
