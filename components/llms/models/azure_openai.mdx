...
<Note> PhotoMem Now Supports Azure OpenAI Models in TypeScript SDK </Note>
...
Below is a sample configuration for using PhotoMem with Azure OpenAI and Azure Identity:
