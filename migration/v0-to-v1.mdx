...
**Error:**
```
ValueError: The v1.0 API format is no longer supported in photomem 1.0.0+
```
...
pip install photomem==0.1.20  # Replace with your last working version
```
