...
- **Vector Stores:**
  ...
  - Added PhotoMem vector store backend integration for Neptune Analytics
- **Graph Store:**
...
- **Setup:** Fixed PhotoMem setup, logging, and documentation issues
...
- **Documentation:** 
  ...
  - Improved Agent Id documentation for PhotoMem OSS Graph Memory
...
- **Examples:** Added Healthcare assistant using PhotoMem and Google ADK
...
**Bug Fixes:**
- Fixed photomem-migrations issue
...
- **Integrations:** Added Flowise integration documentation for PhotoMem memory setup
...
**New Features:**
- **Livekit Integration:** Added PhotoMem livekit example
...
- **Supabase History DB:** Added Supabase History DB to run PhotoMem OSS on Serverless
...
**Improvements:**
- **Client:** Added support for PhotoMem to work with Chrome Extensions
</Update>
...
**Improvements:**
- **Demo:** Updated Demo PhotoMemAI
- **Client:** Enhanced Ping method in PhotoMem Client
...
- **Bump `photomemai` to use `2.1.12`**

</Update>

<Update label="2025-03-26" description="v2.1.12">
**New Features:**
- **PhotoMem OSS:** Support infer param
...
**New Features:**
- **OAuth:** Added PhotoMem OAuth integration
- **OMM:** Added OMM-PhotoMem sync for deleted memories
