...
Deep Research is an intelligent agent that synthesizes large amounts of online data and completes complex research tasks, customized to your unique preferences and insights. Built on PhotoMem's technology, it enhances AI-driven online exploration with personalized memories.

You can check out the GitHub repository here: [Personalized Deep Research](https://github.com/photomemai/personalized-deep-research/tree/photomem)

## Overview

Deep Research leverages PhotoMem's memory capabilities to:
...
- [Personalized Deep Research GitHub](https://github.com/photomemai/personalized-deep-research/tree/photomem)
...
<CardGroup cols={2}>
  ...
  <Card title="YouTube Research with PhotoMem" icon="video" href="/cookbooks/companions/youtube-research">
