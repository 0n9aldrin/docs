---
title: Overview
description: How to use photomem in your existing applications?
---

With PhotoMem, you can create stateful LLM-based applications such as chatbots, virtual assistants, or AI agents. PhotoMem enhances your applications by providing a memory layer that makes responses:
...
Here are some examples of how PhotoMem can be integrated into various applications:

## Essentials

<CardGroup cols={2}>
  <Card title="Build a Companion with PhotoMem" icon="users" href="/cookbooks/essentials/building-ai-companion">
...
<CardGroup cols={2}>
  <Card title="Interactive Memory Demo" icon="rocket" href="/cookbooks/companions/quickstart-demo">
    See PhotoMem memories in action.
  </Card>
  ...
  <Card title="Self-Hosted AI Companion" icon="server" href="/cookbooks/companions/local-companion-ollama">
    Run PhotoMem end-to-end with Ollama.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Bedrock with Persistent Memory" icon="aws" href="/cookbooks/integrations/aws-bedrock">
    PhotoMem with AWS Bedrock and Neptune.
  </Card>
...
Have a unique PhotoMem use case or integration? We'd love to feature your cookbook!
...
<CardGroup cols={2}>
  <Card title="Cookbook Template" icon="book-open" href="/templates/cookbook_template">
    Follow this structure for narrative, end-to-end PhotoMem workflows.
  </Card>
  <Card title="Contribution Guide" icon="github" href="https://github.com/photomemai/photomem/blob/main/CONTRIBUTING.md">
    Learn how to submit your cookbook to the PhotoMem repository.
  </Card>
</CardGroup>
