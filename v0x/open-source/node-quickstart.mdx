...
To install PhotoMem, you can use npm. Run the following command in your terminal:
...
PhotoMem TypeScript SDK support history stores to run on a serverless environment:
...
PhotoMem uses SQLite as a default history store.
...
| Parameter         | Description                          | Default                    |
|------------------|--------------------------------------|----------------------------|
| `historyDbPath` | Path to the history database         | "{photomem_dir}/history.db"    |
