...
description: "Follow the shared playbook for writing and updating PhotoMem documentation."
icon: "clipboard-list"
---

# Build PhotoMem Docs the Right Way
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    description="Configure PhotoMem with third-party tools using shared Tabs + Steps."
    icon="plug"
